...
#You need to put the format arguments into a tuple (add parentheses), Python expects a tuple after % :
print("Your first name is %s and your second name is %s" % (firstname, secondname))

""" 
Each of the %s  placeholders expect one value after %  to be replaced with, but you need to pass these values inside a tuple. 
